...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key="qMuQtCXaoDsD27l2K9woEWS1R",
            project_name="anime-recommendation",
            workspace="katla-adithya"
        )
        logger.info(" Training & comet_ml initialized ..")
    ...
    def extract_weights(self,layer_name,model):
        try:
            ...
            raise CustomException("Error during model weights extraction process",sys)
